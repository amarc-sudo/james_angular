...
export class AuthEmargementGuard implements CanActivate, CanActivateChild, CanDeactivate<unknown>, CanLoad {
  ...
  canActivate(
    ...
    return this.tokenConnexionService.checkConnexionProfesseur(sessionStorage.getItem('email'), sessionStorage.getItem('token')).toPromise().then(value => {
      return value;
    });
  }
